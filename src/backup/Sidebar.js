  ...
  render() {
    ...
    return (
      <div className="sidebar">
        <div className="main-menu" style={{top: '50px'}}>
                      ...
                      >
                        {item.newWindow ? (
                          ...
                          >
                            <i className={item.icon} />{' '}
                            <h6>{item.label}</h6>
                            {/* <p className='queue-count' style={{fontSize: '14px'}}>{item.label === 'Queue' ? this.props.outQueueCount : item.label === 'Export' ? 3 : 5}</p> */}
                            {/* <p className='queue-count' style={{fontSize: '14px'}}>{item.label === 'Queue' ? this.props.outQueueCount : item.label === 'Export' ? this.props.outExportCount : this.props.outImportCount}</p> */}
                            <p className='queue-count' style={{fontSize: '14px'}}>{this.resolveCountMapping(item.label)}</p>
                          </NavLink>
                        )}
                      </NavItem>
                    );
