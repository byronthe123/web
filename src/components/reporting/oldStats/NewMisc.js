                                    ...
                                    <Table style={{tableLayout: 'fixed'}} striped className='mb-1'>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select value={s_misc_type} id={'s_misc_type'} onChange={(e) => handleInput(e)}>
                                                        <option value='ULD OVERAGE'>ULD Overage</option>
                                                        <option value='TRANSFER SKID'>Transfer Skid</option>
                                                ...
                                                </td>
                                                {
                                                    s_misc_type === 'OTHER' && 
                                                    <td>
                                                        <input id={'s_misc_other_value'} value={s_misc_other_value} onChange={(e) => handleInput(e)}  type='text' />
                                                    </td>
                                                }
                                                <td>
