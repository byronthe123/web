...
const IDENTIFICATION: IFileType = {
    uploaded: false,
    singleUpload: true,
    required: true,
    categories: [
...
export interface IFileTypes {
    [name: string]: IFileType
}

export const importTypes: IFileTypes = {
...
const TRANSFER_IMPORT_AWB = _.cloneDeep(AWB);
TRANSFER_IMPORT_AWB.required = true;
export const importTransferTypes: IFileTypes = {
    'IDENTIFICATION': IDENTIFICATION,
    'PICK UP ORDER': {
        uploaded: false,
        modelId: null,
